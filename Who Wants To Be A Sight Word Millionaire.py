...
questions = ["I saw____dog running.",
             "I have a cup____milk.",
             "I see mom____dad.",
             "I____happy today.",
             "You have____see the teacher.",
             "My book was____the car.",
             "She____at school.",
             "Will____play with me?",
             "Is____your dog?",
             "____was a bear in the tree."]

first_option = ["they", "of",
                "an", "amp",
                "too", "in",
                "its", "you", "there", "If"]

second_option = ["then", "off",
                 "ant", "am",
                 "two", "are",
                 "ink", "your", "that", "Ice"]

third_option = ["them", "often",
                "and", "all",
                "tow", "if",
                "is", "yes", "them", "It"]

fourth_option = ["the", "other",
                 "any", "any",
                 "to", "inn",
                 "ill", "thank", "more", "Into"]

correct_answers = ["the", "of", "and", "am", "to", "in",
                   "is", "you", "that", "It"]
...
root.resizable(0, 0)
root.title('Who Wants To Be A Sight Word Millionaire')
